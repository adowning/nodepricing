...
months[11]="December";
    ...
    tarray.push(jan);tarray.push(feb);tarray.push(mar);tarray.push(apr);tarray.push(may);
    tarray.push(jun);tarray.push(jul);tarray.push(aug);tarray.push(sept);tarray.push(oct);tarray.push(nov);
    tarray.push(dec);
    //console.log(tarray);
    return  tarray;
}
